    ...
    public class DistrictController : ControllerBase
    {
        ...
        public IActionResult GetAll(int page = 1, int pageSize = 10)
        {
            try
            {
                ...
                var districts = _districtService.GetAllSync();
                var districtresponse = districts.ToPagedList((int)page, (int)pageSize);
        ...
        [HttpGet("get-one-districts")]

        public IActionResult getOne(int Id)
        {
            try
            {
                var districts = _districtService.GetOne(Id);
        ...
        public IActionResult add([FromBody] DistrictForCreate districtForCreate)
        {
            try
            {
                var districtresponse = _districtService.Add(districtForCreate);
        ...
        public IActionResult delete([FromBody] DistrictForDelete districtForDelete)
        {
            try
            {
                var districtresponse = _districtService.Delete(districtForDelete);
        ...
        public IActionResult update([FromBody] DistrictForUpdate districtForUpdate)
        {
            try
            {
                var districtresponse = _districtService.Update(districtForUpdate);
